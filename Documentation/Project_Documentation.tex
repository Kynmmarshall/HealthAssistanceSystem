...
\hypersetup{
  ...
  pdfauthor={ICT2223 Java Programming 2},
...
\begin{tabular}{@{}ll@{}}
  \color{AccentTeal}\textbf{Course Code:}  & \color{White}ICT2223 \\[6pt]
  ...
  \color{AccentTeal}\textbf{Group Number:} & \color{White}32 \\[6pt]
